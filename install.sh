...
echo "============================================"
echo ""
echo "  To connect to Claude Code (run once to register persistently):"
echo "    claude mcp add --scope user loredocs -- $VENV_DIR/bin/python -m loredocs.server"
echo ""
echo "  Add --env=LOREDOCS_PRO=<key> before 'loredocs' if you have a Pro license."
echo ""
echo "  To use in a single session only (not persistent):"
